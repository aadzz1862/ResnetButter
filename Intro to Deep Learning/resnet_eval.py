...
num_classes = len(os.listdir("/Users/aishwaryamallikarjun/Desktop/Intro to Deep Learning/archive/train"))

model = ResNet50(ResidualBlock, [3, 4, 6, 3], num_classes=num_classes)
model = model.to(device)

model_checkpoint = torch.load("../checkpoints/model_epoch_1.pt") # Path to be changed
